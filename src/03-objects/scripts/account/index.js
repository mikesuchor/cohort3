...
document.addEventListener("click", () => {
    ...
    if(event.target.className === "deposit-button action-button" || event.target.className === "fas fa-sign-in-alt") {
        ...
        // Refactor this
        event.target.previousSibling.previousSibling.innerText = accountController.accounts[accountIndex].deposit(Number(inputAmount.value));
        inputAmount.value = "";
    }
    ...
    if(event.target.className === "withdraw-button action-button" || event.target.className === "fas fa-sign-out-alt") {
        ...
        // Refactor this
        event.target.previousSibling.previousSibling.previousSibling.innerText = accountController.accounts[accountIndex].withdraw(inputAmount.value);
        inputAmount.value = "";
    }
});